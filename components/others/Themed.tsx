...
export function VStack(props: ViewProps) {
  ...
  return <DefaultView style={[{ backgroundColor, alignItems: "center" }, style]} {...otherProps} />;
}
...
export function HStack(props: ViewProps) {
  ...
  return <DefaultView style={[{ backgroundColor, flexDirection: "row", alignItems: "center" }, style]} {...otherProps} />;
}
